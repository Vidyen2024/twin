...
def call_bedrock(conversation: List[Dict], user_message: str) -> str:
    ...
    # Build messages in Bedrock format — must strictly alternate user/assistant
    messages = []
    ...
    try:
        ...
        # System prompt is passed via the dedicated `system` parameter so it
        # never breaks the required user/assistant alternation in `messages`
